...
\begin{align*}
S_{t+1}&=S_t-\lambda_tS_{t-1}+\rho I_{t-1}\\
S_{t+1}&=I_t+\lambda_tS_{t-1}-\rho I_{t-1}
\end{align*}
...
If we do not know either $D$ or $D'$ (or both), then we cannot use either of the above expressions. Assuming these periods follow an exponential distribution, then we can write the reproductive number as a function of the growth rate, $\Lambda$, and the serial interval, $T_s$, which is the average . 
